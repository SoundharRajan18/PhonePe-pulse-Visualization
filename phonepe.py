...
def map_insur_Districts(df,state):
    ...
    with col1:
        fig_bar_1 = px.bar(tacyg, x= "Transaction_amount",y ="Districts",orientation="h",height= 600,
                            title = f"{state.upper()} DISTRICT AND TRANSACTION AMUONT",color_discrete_sequence=px.colors.sequential.Mint_r )
        st.plotly_chart(fig_bar_1)

    with col2:
        fig_bar_2 = px.bar(tacyg, x= "Transaction_count",y ="Districts",orientation="h",height = 600,
                            title = f"{state.upper()} DISTRICT AND TRANSACTION COUNT",color_discrete_sequence=px.colors.sequential.RdBu )
        st.plotly_chart(fig_bar_2)
...
def map_user_plot_1(df,year):
    ...
    fig_line_1 = px.line(muyg,x= "States",y= ["RegisteredUsers","AppOpens"],
                        title=f"{year} REGIDTEREDUDERS APPOPENS",width=1000,height=800,markers=True)
    st.plotly_chart(fig_line_1)
...
def map_user_plot_2(df,quarter):
    ...
    fig_line_1 = px.line(muyqg,x= "States",y= ["RegisteredUsers","AppOpens"],
                        title=f"{df['Years'].min()} YEAR {quarter} QUARTER REGIDTEREDUDERS APPOPENS",width=1000,height=800,markers=True,
...
def top_insurance_plot_1(df,state):
    ...
    with col1:
        fig_map_user_bar_1 = px.bar(tiy, x="Quarter", y="Transaction_amount",hover_data="Pincodes",
                                        title= "TRANSACTION AMOUNT",height=650,width=600,color_discrete_sequence=px.colors.sequential.Bluered)
        st.plotly_chart(fig_map_user_bar_1)

    with col2:
        fig_map_user_bar_2 = px.bar(tiy, x="Quarter", y="Transaction_count",hover_data="Pincodes",
                                        title= "TRANSACTION COUNT",height=650,width=600,color_discrete_sequence=px.colors.sequential.GnBu_r)
        st.plotly_chart(fig_map_user_bar_2)
...
def top_user_plot_2(df,state):
    ...
    fig_top_plot_2 = px.bar(tuys, x="Quarter",y="RegisteredUsers",title=f"REGISTERED USER ,PINCODES,QUARTER",
                            width=800,height=800,color="RegisteredUsers",hover_data="Pincodes",
...
def top_chart_transaction_amount(table_name):
        ...
        col1,col2 = st.columns(2)
        with col1:
            fig_amount  = px.bar(df_1, x = "states",y= "transaction_amount",title ="TOP 10 OF TRANSACTION AMOUNT",hover_data="states",
                            color_discrete_sequence=px.colors.sequential.Aggrnyl,height=650, width=600)
            st.plotly_chart(fig_amount)
        ...
        with col2:
            fig_amount_2 = px.bar(df_2, x = "states",y= "transaction_amount",title ="LAST 10 OF TRANSACTION AMOUNT",hover_data="states",
        ...
        fig_amount_3 = px.bar(df_3, x = "transaction_amount",y= "states",title ="AVARAGE OF TRANSACTION AMOUNT",hover_data="states",orientation="h",
                        color_discrete_sequence=px.colors.sequential.Redor,height=800, width=1000)
...
def top_chart_transaction_count(table_name):
        ...
        col1,col2= st.columns(2)
        with col1:
            fig_amount  = px.bar(df_1, x = "states",y= "transaction_count",title =" TOP 10 OFTRANSACTION COUNT",hover_data="states",
                            color_discrete_sequence=px.colors.sequential.Aggrnyl,height=650, width=600)
            st.plotly_chart(fig_amount)
        ...
        with col2:
            fig_amount_2 = px.bar(df_2, x = "states",y= "transaction_count",title =" LAST 10 OF TRANSACTION COUNT",hover_data="states",
                    color_discrete_sequence=px.colors.sequential.Aggrnyl_r,height=650, width=600)
            st.plotly_chart(fig_amount_2)
        ...
        fig_amount_3 = px.bar(df_3, x = "transaction_count",y= "states",title ="AVARAAGE OF TRANSACTION COUNT",hover_data="states",orientation="h",
                        color_discrete_sequence=px.colors.sequential.Reds_r,height=800, width=1000)
        st.plotly_chart(fig_amount_3)
...
def top_chart_registered_user(table_name,state):
        ...
        col1,col2=st.columns(2)
        with col1:
            fig_amount  = px.bar(df_1, x = "districts",y= "registereduser",title ="TOP 10 OFREGISTERED USER",hover_data="districts",
                            color_discrete_sequence=px.colors.sequential.Aggrnyl,height=650, width=600)
            st.plotly_chart(fig_amount)
        ...
        with col2:
            fig_amount_2 = px.bar(df_2, x = "districts",y= "registereduser",title ="LAST 10 OF REGISTERED USER",hover_data="districts",
                            color_discrete_sequence=px.colors.sequential.Aggrnyl_r,height=650, width=600)
            st.plotly_chart(fig_amount_2)
        ...
        fig_amount_3 = px.bar(df_3, y = "districts",x= "registereduser",title ="AVARAGE OF REGISTERED USER",hover_name="districts",orientation="h",
                        color_discrete_sequence=px.colors.sequential.Reds,height=800, width=1000)
...
def top_chart_appopens(table_name,state):
        ...
        with col1:
            ...
            fig_amount= px.bar(df_1, x ="districts",y="appopens",title ="TOP 10 OF APPOPENS",hover_data="districts",
                            color_discrete_sequence=px.colors.sequential.Aggrnyl,height=650, width=600)
        ...
        with col2:
            ...
            fig_amount_2 = px.bar(df_2, x = "districts",y= "appopens",title ="LAST 10 OF APPOPENS",hover_data="districts",
                            color_discrete_sequence=px.colors.sequential.Aggrnyl_r,height=650, width=600)
            st.plotly_chart(fig_amount_2)
...
def top_chart_registered_users(table_name):
        ...
        col1,col2=st.columns(2)
        with col1:
            fig_amount  = px.bar(df_1, x = "states",y= "registeredusers",title ="TOP 10 OFREGISTERED USERS",hover_data="states",
                            color_discrete_sequence=px.colors.sequential.Aggrnyl,height=650, width=600)
            st.plotly_chart(fig_amount)
        ...
        with col2:
            fig_amount_2 = px.bar(df_2, x = "states",y= "registeredusers",title ="LAST 10 OF REGISTERED USERS",hover_data="states",
                            color_discrete_sequence=px.colors.sequential.Aggrnyl_r,height=650, width=600)
            st.plotly_chart(fig_amount_2)
...
if select == "HOME":
    ...
    with col2:
        st.image(Image.open(r"C:\Users\ADMIN\Desktop\phonepe\PhonePe-Web.jpg"),width= 700)

    col3,col4= st.columns(2)

    with col3:
        st.image(Image.open(r"C:\Users\ADMIN\Desktop\phonepe\images.jfif"),width=600)
    ...
    with col6:
        st.image(Image.open(r"C:\Users\ADMIN\Desktop\phonepe\images (1).jfif"),width= 700)

elif select == "DATA EXPLORATION":

    tab1, tab2, tab3 = st.tabs(["Aggregated Analysis","Map Analaysis","Top Analysis"])
    ...
    with tab1:
        ...
        if method ==  "Insurance Analysis":
            ...
            col1,col2 = st.columns(2)
            with col1:
                states = st.selectbox( "Select The State_type",Aggre_tran_tac_Y_Q["States"].unique())
